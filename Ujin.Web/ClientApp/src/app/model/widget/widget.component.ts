import { Component, OnInit, OnChanges, Input, SimpleChanges, EventEmitter, Output, ChangeDetectorRef, ViewChildren, QueryList } from '@angular/core';
...
export class WidgetComponent implements OnInit, OnChanges {
  ...
  @ViewChildren(SelectorConfigComponent)
  public selectorConfigs: QueryList<SelectorConfigComponent>;
  ...
  public swipe(shift: number) {
    this.selectorConfigs.forEach(sc => {
      if (sc.configuration === this.selectedConfig) {
        sc.shiftValue(shift);
      }
    });
  }
